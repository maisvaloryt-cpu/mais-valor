...
const LOGO_SVG_HTML = `<svg viewBox="0 0 530 530" xmlns="http://www.w3.org/2000/svg" width="64" height="64" style="display:block;border-radius:12px;overflow:hidden;flex-shrink:0">
